 <!-- Navbar -->
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand cp-nav-brand-ac" href="javascript:void(0);">OshoTR</a>
          </div>
      ...
      <!-- End Navbar --><?php /**PATH C:\xampp\htdocs\oshotr\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>