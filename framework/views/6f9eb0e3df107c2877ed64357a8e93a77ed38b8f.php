<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 section-2-main">
	<?php
	   $pet = DB::table('pets')->where('pet_name','Cat')->value('id');
	 ...
	 ?>
	<div class="st-main">CAT FOODS</div>
	...
	<div class="all-view-more"><a href="<?php echo e(url('/cat/cat-food')); ?>">View More</a></div>

</div>
<?php /**PATH C:\xampp\htdocs\mawandbaw\resources\views/frontend/homepage/cat-food-section.blade.php ENDPATH**/ ?>