...
<div class="container mt-100">
    <div class="row" style="justify-content: center;">
        ...
        <div class="col-6 col-md-3 col-sm-4">
            <div class="card mb-30"><a class="card-img-tiles" href="<?php echo e(route('cat-products-list',$category->slug)); ?>" data-abc="true">
                    <div class="inner">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mawandbaw\resources\views/frontend/pets/cat/cats-category.blade.php ENDPATH**/ ?>