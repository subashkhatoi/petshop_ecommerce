<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 section-2-main">
	<?php
	 ...
	 ?>
	<div class="st-main">TRENDING</div>
    ...
    <div class="Cust-df-row">
    	...
    	<?php
              ...
              $round_off_percentage = round($off_percentage,1);
         ?>
...
<?php /**PATH C:\xampp\htdocs\mawandbaw\resources\views/frontend/homepage/trending-section.blade.php ENDPATH**/ ?>